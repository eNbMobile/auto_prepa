...
void rewrite_bon_encaissement_02()
{
	...
	while (i < nbLignes)
	{
		...
		if ((gencod[0] != '3' || gencod[1] != '3' || gencod[2] != '6' || gencod[3] != '8' || gencod[4] != '9' || gencod[5] != '5' || gencod[6] != '8' || gencod[7] != '4' || gencod[8] != '6' || gencod[9] != '7' || gencod[10] != '8' || gencod[11] != '0' || gencod[12] != '9') && gencod[0] != '9')
		{
